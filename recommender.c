...
void recommender(int uid)
{
	...
	get_utility_matrix(utility_matrix, "/mnt/e/coding-projects/scientific-computing-assignment/Dataset/ratings_learn.csv", No_of_movies, No_of_users, userid); // getting utility matrix which will contain ratings according to user id(row) and movie id(coloumn)
	get_movie_names(movienames, "/mnt/e/coding-projects/scientific-computing-assignment/Dataset/movies.csv");												   // getting movie names according to movie id(index)
	get_movie_genres(moviegenres, "/mnt/e/coding-projects/scientific-computing-assignment/Dataset/movies_genres.csv");										   // getting movie genres according to movie id(index)
	...
	new_user_movies(newuser, "/mnt/e/coding-projects/scientific-computing-assignment/Dataset/ratings_learn.csv", userid);
	...
	for (int i = 0; i < No_of_users; i++)
	{
		...
		{
			printf("NaN similarity at user %d\n", i);
			exit(1);
		}
	}
	...
	printf("Number of similar users: %d\n", no_of_susers);

	if (no_of_susers == 0)
	{
		printf("ERROR: No similar users found. Exiting.\n");
		return;
	}
