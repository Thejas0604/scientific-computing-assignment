...
void ratemovie(int uid){
	int movieid;
	double rating;
	FILE *fstream = fopen("/mnt/e/coding-projects/scientific-computing-assignment/Dataset/ratings_learn.csv","a");
...
void getmovies(int uid){
	...
	get_movie_names(movienames,"/mnt/e/coding-projects/scientific-computing-assignment/Dataset/movies.csv");
	get_movie_genres(moviegenres,"/mnt/e/coding-projects/scientific-computing-assignment/Dataset/movies_genres.csv");
